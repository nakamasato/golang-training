...
func (ac *AnimalCreate) SetColor(s string) *AnimalCreate {
	ac.mutation.SetColor(s)
	return ac
}

// SetGender sets the "gender" field.
func (ac *AnimalCreate) SetGender(s string) *AnimalCreate {
...
func (ac *AnimalCreate) check() error {
	if _, ok := ac.mutation.Color(); !ok {
		return &ValidationError{Name: "color", err: errors.New(`ent: missing required field "Animal.color"`)}
	}
